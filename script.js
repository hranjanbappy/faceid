...
Promise.all([
  faceapi.nets.faceRecognitionNet.loadFromUri('/master/models/'),
  faceapi.nets.faceLandmark68Net.loadFromUri('/master/models/'),
  faceapi.nets.ssdMobilenetv1.loadFromUri('/master/models/')
]).then(start)
